cask "lazarus" do
  ...
  url "https://gigenet.dl.sourceforge.net/project/lazarus/Lazarus%20macOS%20x86-64/Lazarus%203.0/Lazarus-3.0-macosx-x86_64.pkg",
  ...
  pkg "Lazarus-3.0-macosx-x86_64.pkg"
