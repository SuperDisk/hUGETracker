...
tar xf lame.tar.gz
pushd lame-3.100
./configure --prefix="`_realpath ..`/lame-install" --disable-dependency-tracking --enable-static --disable-shared --enable-nasm --disable-gtktest --disable-decoder --disable-frontend
make
make install
popd
