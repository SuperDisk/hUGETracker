...
{$MACRO ON}
{$define Z_FLAG:=(af.l and 128)}
{$define N_FLAG:=(af.l and 64)}
{$define H_FLAG:=(af.l and 32)}
{$define C_FLAG:=(af.l and 16)}
...
function inc_b: byte;
begin
  af.l := inc_f[bc.h] or C_FLAG; //(af.l and 1);
  Inc(bc.h);
...
begin
  btemp := C_FLAG;
  af.l := rlca_f[btemp][af.h] or Z_FLAG; //(af.l and 196);
...
function inc_c: byte;
begin
  af.l := inc_f[bc.l] or C_FLAG; //(af.l and 1);
  Inc(bc.l);
...
function dec_c: byte;
begin
  af.l := dec_f[bc.l] or C_FLAG; //(af.l and 1);
  Dec(bc.l);
...
var
  btemp: byte;
begin
  btemp := C_FLAG; //af.l and 1;
  af.l := rrca_f[btemp][af.h] or Z_FLAG; //(af.l and 196);
...
function inc_d: byte;
begin
  af.l := inc_f[de.h] or C_FLAG; //(af.l and 1);
  Inc(de.h);
...
function dec_d: byte;
begin
  af.l := dec_f[de.h] or C_FLAG; //(af.l and 1);
  Dec(de.h);
...
begin
  btemp := C_FLAG; //af.l and 1;
  af.l := rla_f[btemp][af.h] or Z_FLAG; //(af.l and 196);
...
function inc_e: byte;
begin
  af.l := inc_f[de.l] or C_FLAG; //(af.l and 1);
  Inc(de.l);
...
function dec_e: byte;
begin
  af.l := dec_f[de.l] or C_FLAG; //(af.l and 1);
  Dec(de.l);
...
function rra: byte;
begin
  if C_FLAG {af.l and 1} = 0 then
  begin
    af.l := rra_f[af.h] or Z_FLAG; //(af.l and 196);
    af.h := rra_a[0][af.h];
  end
  else
  begin
...
function inc_h: byte;
begin
  af.l := inc_f[hl.h] or C_FLAG; //(af.l and 1);
  Inc(hl.h);
...
function dec_h: byte;
begin
  af.l := dec_f[hl.h] or C_FLAG; //(af.l and 1);
  Dec(hl.h);
...
var
  daa_select: byte;
begin
  daa_select := %01110000; // H, N and C //af.l and 19;
  if daa_select and %00100000 {and 16} > 0 then
  begin
    af.l := daa_f[daa_select - 12][af.h]; {TODO}
...
function inc_l: byte;
begin
  af.l := inc_f[hl.l] or C_FLAG; //(af.l and 1);
  Inc(hl.l);
...
function dec_l: byte;
begin
  af.l := dec_f[hl.l] or C_FLAG; //(af.l and 1);
  Dec(hl.l);
...
function cpl: byte;
begin
  af.h := af.h xor %11111111;
  af.l := af.l or %01100000; {n and h} //18;
...
begin
  btemp := speekb(hl.W);
  af.l := inc_f[btemp] or C_FLAG; //(af.l and 1);
  spokeb(hl.W, btemp + 1);
...
begin
  btemp := speekb(hl.W);
  af.l := dec_f[btemp] or C_FLAG; //(af.l and 1);
  spokeb(hl.W, btemp - 1);
...
function scf: byte;
begin
  af.l := (af.l and %10000000) or %00010000;
...
begin
  af.l := inc_f[af.h] or C_FLAG; //(af.l and 1);
  Inc(af.h);
...
begin
  af.l := dec_f[af.h] or C_FLAG; //(af.l and 1);
  Dec(af.h);
...
function ccf: byte;
begin
  af.l := (af.l xor C_FLAG) and %10010000;
...
begin
  af.l := bit_f0[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f0[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f0[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f0[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f0[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f0[hl.l] or C_FLAG; //af.l and 1;
...
function bit0: byte;
begin
  af.l := bit_f0[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f0[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[hl.l] or C_FLAG; //af.l and 1;
...
function bit1: byte;
begin
  af.l := bit_f1[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f1[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[hl.l] or C_FLAG; //af.l and 1;
...
function bit2: byte;
begin
  af.l := bit_f2[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f2[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[hl.l] or C_FLAG; //af.l and 1;
...
function bit3: byte;
begin
  af.l := bit_f3[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f3[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[hl.l] or C_FLAG; //af.l and 1;
...
function bit4: byte;
begin
  af.l := bit_f4[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f4[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[hl.l] or C_FLAG; //af.l and 1;
...
function bit5: byte;
begin
  af.l := bit_f5[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f5[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[hl.l] or C_FLAG; //af.l and 1;
...
function bit6: byte;
begin
  af.l := bit_f6[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f6[af.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[bc.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[bc.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[de.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[de.l] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[hl.h] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[hl.l] or C_FLAG; //af.l and 1;
...
function bit7: byte;
begin
  af.l := bit_f7[speekb(Addr)] or C_FLAG; //af.l and 1;
...
begin
  af.l := bit_f7[af.h] or C_FLAG; //af.l and 1;
