    ...
    case address of
      ...
      begin
        ...
        pal_dx_b[((m_iram[$ff68]) and 56) shr 3][((m_iram[$ff68]) and 6) shr 1] :=
          ...
          (8 - dx_r)) shl dx_sr) or (((pal_b[((m_iram[$ff68]) and 56) shr 3][
          ((m_iram[$ff68]) and 6) shr 1][1]) shr (8 - dx_g)) shl dx_sg) or
          (((pal_b[((m_iram[$ff68]) and 56) shr 3][((m_iram[$ff68]) and 6) shr 1][0]) shr
          (8 - dx_b)) shl dx_sb);
      ...
      begin
        ...
        pal_dx_o[((m_iram[$ff6a]) and 56) shr 3][((m_iram[$ff6a]) and 6) shr 1] :=
          (((pal_o[((m_iram[$ff6a]) and 56) shr 3][((m_iram[$ff6a]) and 6) shr 1][2]) shr
          (8 - dx_r)) shl dx_sr) or (((pal_o[((m_iram[$ff6a]) and 56) shr 3][
          ((m_iram[$ff6a]) and 6) shr 1][1]) shr (8 - dx_g)) shl dx_sg) or
          (((pal_o[((m_iram[$ff6a]) and 56) shr 3][((m_iram[$ff6a]) and 6) shr 1][0]) shr
          (8 - dx_b)) shl dx_sb);
