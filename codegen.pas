...
procedure RenderSongToHTTs(Song: TSong; DescriptorName: String; Filename: string);
...
begin
  ...
  WriteHTT('./hUGEDriver/'+DescriptorName+'_constants.htt', RenderConstants(Song, Mode));
  WriteHTT('./hUGEDriver/'+DescriptorName+'_wave.htt', RenderWaveforms(Song.Waves));
  WriteHTT('./hUGEDriver/'+DescriptorName+'_order.htt', RenderOrderTable(Song.OrderMatrix));
  WriteHTT('./hUGEDriver/'+DescriptorName+'_duty_instrument.htt', RenderInstruments(Song.Instruments.Duty));
  WriteHTT('./hUGEDriver/'+DescriptorName+'_wave_instrument.htt', RenderInstruments(Song.Instruments.Wave));
  WriteHTT('./hUGEDriver/'+DescriptorName+'_noise_instrument.htt',
...
begin
  ...
  RenderSongToHTTs(Song, DescriptorName, Filename);
